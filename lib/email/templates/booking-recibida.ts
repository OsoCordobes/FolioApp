 ...
 * `fechaHoraLabel` pre-computado por el caller).
 */

import type { BookingEmailInput } from "./booking-confirmada";
          ...
          <table role="presentation" width="480" cellpadding="0" cellspacing="0" style="background:#fffdf8;border-radius:12px;border:1px solid #e6dcc8;overflow:hidden;">
            <tr>
              <td style="background:#8a6d3b;padding:20px 28px;">
                <h1 style="margin:0;color:#fffdf8;font-size:20px;font-weight:600;">Solicitud recibida</h1>
              </td>
            </tr>
            <tr>
              <td style="padding:28px;">
                ...
                <p style="margin:0;color:#6b5e4f;font-size:13px;line-height:1.5;">No hace falta que hagas nada más por ahora. Si querés modificar tu solicitud, respondé este correo.</p>
              </td>
            </tr>
            <tr>
