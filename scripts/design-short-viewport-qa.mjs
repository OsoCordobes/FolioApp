...
const stubs = {
  ...
  '@/app/(app)/hoy/actions': `export async function loadCreateTurnoMeta(){return {ok:true,data:{servicios:[{id:'synthetic-service',nombre:'Consulta de ejemplo',duracionMin:45}],pacientes:[],profesionales:[{id:'synthetic-prof-1',displayName:'Profesional de ejemplo'},{id:'synthetic-prof-2',displayName:'Segundo profesional de ejemplo'}],sessionMemberId:'synthetic-prof-1'}}};export async function searchPacientesAction(){return {ok:true,data:[]}};export function createTurnoAction(){qa.writes++;throw new Error('Mutations forbidden in visual fixture')}`,
};
