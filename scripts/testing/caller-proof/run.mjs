...
async function main(){
 ...
 try{
  ...
  const mfaDiagnostic=result.output.match(/caller_proof_mfa_diagnostic:path=(mfa|hoy|other) alert=(validation|session|session_check|rate|factor_list|factor_missing|challenge|otp|policy_read|policy|network|none|unknown)/);
