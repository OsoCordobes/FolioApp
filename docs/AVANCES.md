...
| **Portal y exportación** · base publicada; descarga en construcción | C · revisión A; [base de entrega publicada](https://github.com/OsoCordobes/FolioApp/pull/180),23 pruebas específicas. La descarga en un solo archivo tiene pruebas locales aprobadas; la revisión independiente detectó tres ajustes que C está corrigiendo. Falta el ensayo real de50MB en navegador. Historias excepcionalmente grandes requieren resolver un límite de tiempo; el checkpoint completo sigue abierto. |
