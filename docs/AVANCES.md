...
| **Atención adulta** · base en revisión | B04 · revisión independiente; prepara un registro protegido de quién comprobó los datos de edad. Cerró cuatro hallazgos de revisión y está protegiendo también la autoría histórica. Pruebas de base de datos pendientes; no activa bloqueos ni cambia historias. |
...
**Última publicación comprobada:** [PR182 · historia y archivos en una descarga](https://github.com/OsoCordobes/FolioApp/pull/182), desde el 25/09 a las 11:59 (Copenhague). Para probar: Mis datos y solicitudes → Archivo clínico → Preparar o retomar entrega → Guardar historia y archivos, con cuenta autorizada y navegador compatible. Control automático posterior de master también aprobado. **Última cuota consultada:** 69% disponible; reserva de cierre: 15%.
