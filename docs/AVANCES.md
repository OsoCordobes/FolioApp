...
| **Ficha completada por el paciente** · base publicada; formulario en revisión | [PR186 publicada y comprobada](https://github.com/OsoCordobes/FolioApp/pull/186), datos previos conservados. Formulario móvil y QR construidos; antes de habilitarlos se cierra la recuperación de enlaces ante cortes y se comprueba el recorrido completo con datos ficticios. |
