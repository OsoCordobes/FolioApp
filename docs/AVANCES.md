...
| **Miniweb profesional** · revisión de permiso en curso | Diseño y controles aprobados; A detectó un posible problema de autoría del permiso al cambiar la cuenta del profesional. D lo está comprobando antes de publicar. [Entrega y pruebas](https://github.com/OsoCordobes/FolioApp/pull/171). |
