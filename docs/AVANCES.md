...
**Equipo comprobado:** A · dirección, revisión y publicación. C · prepara la entrega completa de archivos. D · comprueba registro, confirmación, reingreso y recuperación de contraseña. Los dos subagentes trabajan en paralelo.
...
| **Permisos de Clínica** · paquete publicado; ampliación probada | Pedidos y motivos protegidos según el rol: [PR170 publicada](https://github.com/OsoCordobes/FolioApp/pull/170). C · revisión A; [PR174](https://github.com/OsoCordobes/FolioApp/pull/174) impide entregar una firma si se revoca el acceso durante su descarga. |
...
| **Portal y exportación** · corrección integrada | Ahora la exportación falla con aviso si un dato no puede leerse. C · revisión A; [PR173 integrada](https://github.com/OsoCordobes/FolioApp/pull/173) con sus controles aprobados, publicación en verificación. La entrega completa de archivos sigue aparte. |
...
**Última publicación comprobada:** [PR172 · agenda de recepción](https://github.com/OsoCordobes/FolioApp/pull/172), disponible desde el 25/09 a las 02:44 (Copenhague). Conserva la nueva miniweb, recuperación y permisos previos. **Última cuota consultada:** 90% disponible; reserva de cierre: 15%.
