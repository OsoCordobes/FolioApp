...
| **Llamador de recepción** · base publicada; pantalla en construcción | D · revisión A; [PR179 publicada](https://github.com/OsoCordobes/FolioApp/pull/179) prepara permisos, códigos y revocación. [Pantalla y controles en prueba](https://github.com/OsoCordobes/FolioApp/pull/181); corregimos el acceso independiente del televisor antes de publicar. |
...
| **Portal y exportación** · base de archivos publicada; descarga en construcción | C · revisión A; [PR178 publicada](https://github.com/OsoCordobes/FolioApp/pull/178). [Prueba aprobada](https://github.com/OsoCordobes/FolioApp/actions/runs/36090170105): archivos reconstruidos, reintentos sin duplicación y revocación; La [base de entrega ya publicada](https://github.com/OsoCordobes/FolioApp/pull/180) pasó23 pruebas específicas; sigue la descarga completa desde la aplicación. |
...
**Última publicación comprobada:** [PR180 · entrega protegida de archivos](https://github.com/OsoCordobes/FolioApp/pull/180), desde el25/09 a las06:35 (Copenhague); falta terminar la descarga completa desde la app. La mejora visible más reciente sigue siendo guardar servicios durante el onboarding, salir y volver sin perderlos. **Última cuota consultada:** 77% disponible; reserva de cierre: 15%.
