...
| **Portal y exportación** · base publicada; descarga en construcción | C · revisión A; [base de entrega publicada](https://github.com/OsoCordobes/FolioApp/pull/180),23 pruebas específicas. [Descarga completa en revisión](https://github.com/OsoCordobes/FolioApp/pull/182):14 pruebas específicas y20 escenarios de navegador aprobados; [ensayo de archivo cercano a50MB aprobado](https://github.com/OsoCordobes/FolioApp/actions/runs/36119458957), incluida interrupción sin dañar copia anterior; cierre visual y comprobación final pendientes. Historias excepcionalmente grandes requieren resolver un límite de tiempo; el checkpoint completo sigue abierto. |
...
**Última publicación comprobada:** [PR180 · entrega protegida de archivos](https://github.com/OsoCordobes/FolioApp/pull/180), desde el25/09 a las06:35 (Copenhague); falta terminar la descarga completa desde la app. La mejora visible más reciente sigue siendo guardar servicios durante el onboarding, salir y volver sin perderlos. **Última cuota consultada:** 72% disponible; reserva de cierre: 15%.
