...
| **Llamador de recepción** · base publicada; pantalla en prueba | D · revisión A; [PR179 publicada](https://github.com/OsoCordobes/FolioApp/pull/179) prepara permisos, códigos y revocación. [Pantalla y controles](https://github.com/OsoCordobes/FolioApp/pull/181): la prueba alcanzó el emparejamiento y detectó un problema móvil, ya corregido. [Ensayo de recepción en curso](https://github.com/OsoCordobes/FolioApp/actions/runs/36118247623) con sesión real verificada; corrigiendo obstáculos de la prueba antes de publicar. |
