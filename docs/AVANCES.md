...
| **Portal y exportación** · base publicada; descarga en construcción | C · revisión A; [base de entrega publicada](https://github.com/OsoCordobes/FolioApp/pull/180),23 pruebas específicas. La descarga en un solo archivo pasó8 controles locales; faltan navegador y ensayo real de50MB. Historias excepcionalmente grandes requieren resolver un límite de tiempo; el checkpoint completo sigue abierto. |
