...
Dirección confirmada por el titular: base visual Folio con identidad del profesional o clínica. B implementará onboarding; D página pública y preview compartida. A fijará el SHA exacto de integración al habilitar escritura de cada paquete. Hasta entonces son contratos preparados, no tareas iniciadas ni características publicadas.
...
- Bootstrap atómico/idempotente con tipo y condición asistencial explícitos. Si requiere esquema/RPC, migración nueva M126 reservada, preservando wrappers de seguridad existentes; sin editar M33/M37/M101 ni convertir organizaciones completadas por un payload nuevo. Migración revisada y autorizada antes del despliegue dependiente.
