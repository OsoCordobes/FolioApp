...
| C01 | Bloqueante / evidencia pendiente | C / D | preparador y lock aprobados; motor Docker recuperado; ensayo pendiente | Preparador `6f2dc4e` y lock `c4eadd6` aprobados e integrados; CI Linux PASS. Docker Server29.3.0 y EnableDockerAI efectivo false comprobados; otros ajustes/ACL intactos. Propuesta de destino PG17/Auth/Storage dedicado preparada; ejecución espera cupo posterior a B02b/D02. Restauración completa/Auth/Storage/login/descifrado todavía no acreditados |
