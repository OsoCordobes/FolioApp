...
|---|---|---|
| B06b3a · API de entrega | C `c01_restore_storage`; `C:/Users/amiun/.codex/worktrees/folio-export-delivery-api/folio-app`, rama `codex/launch-export-delivery-api` | Candidato revisado `3025918f997542204a3d2536c82b4230c9da8e39`, árbol `5cd9b69b5f8b4b47d766006d232ddea3348a691f`; master0684eab integrado.14 archivos,10 focales/typecheck/lint PASS. A detectó por lectura error RPC confundido con ausencia y auditoría posterior a guardas finales. C reprodujo cuatro fallos reales antes de corregir (RED: dos lecturas inciertas, revocación durante auditoría y handler entregando bytes). Evidencia `b06b3a-red-uncertain-read-audit-20260925.log`, SHA256 `E85ED10909723B17C4DE447CB58CF9CF51B694A7627697EBF98CF691DDDB2076`. Corrige esos casos, añade límites/Origin y coherencia de hashes. Sin push; esperar SHA final y revisión del delta. M140 `20260925034201_M140_export_package_delivery.sql` sólo local. API profesional, recuperación de operación, manifiesto paginado y fragmentos≤3MiB. Permiso/fuente/READY/TTL antes y después de lectura; retirada posterior a READY bloquea entrega. Revisión SQL temprana A conforme; revisión final, unidades/SQL/CI pendientes. No UI aún. |
