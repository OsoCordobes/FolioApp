...
| C01 | Bloqueante / evidencia pendiente | C / B | preparador aprobado; harness CI en desarrollo | Docker local preservado sin arranque. Runtime sintético PG17/Auth/Storage en runner efímero, contrato descrito al final. Restauración completa todavía no acreditada |
