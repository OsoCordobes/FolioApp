...
Completar Cloudflare ya autorizado cuando vuelva Chrome. PR166 reúne B01, B02a y D01 revisados; verificar checks del SHA final en la PR y preparar autorización concreta de publicación. El futuro B03/M124 va por separado y deberá desactivar su auto-Preview Vercel antes de cualquier push. C01 conserva su bloqueo hasta readback del motor y ensayo completo; no sustituirlo por pruebas parciales ni repetir el smoke clínico cerrado.
