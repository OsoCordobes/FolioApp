...
Continuación autorizada: trabajar hasta cerca del 10% semanal y **dejar al menos ese 10% para el titular y Lorenzo mañana**. Última lectura: 13% restante. El titular rechazó la dirección visual de PR168 centrada en colores/tarjeta: vuelve a borrador, sin autorización de publicación. D reformula la miniweb común y A/B revisan únicamente ese alcance. C01 sigue detenido y C05 sin activar. No abrir otras campañas; detener ampliaciones al12% y preservar10%.
...
- Escritura actual: D reformula D03 como miniweb común de Folio tras el rechazo visual del titular; A mantiene tablero e integración. B terminó el mapa de datos y espera el SHA para revisión focal. C01 quedó detenido por esta ventana. Máximo dos escritores de implementación, cada uno en su ámbito. B02b y D02 publicados en PR166.
...
| C01 | Bloqueante / evidencia pendiente | C / B + revisión independiente A | PR167 borrador; bloqueado en arranque aislado | Candidato1f76985 revisado, dos tenants y negativas precisas incorporadas. Runs35515864967 y35516293607 fallaron antes de migraciones: servicios arrancados pero puertos DB/gateway sin publicar y API sin respuesta. No acredita backup/restore/login/MFA/Storage. Docker local preservado; frente detenido por esta ventana |
...
| D03 | Alta / reforma solicitada con captura real y corrección de dirección | D / B + A visual + titular | reformulación visual en curso; PR168 borrador sin autorización | La versión centrada en paleta pasó controles técnicos pero fue rechazada por el titular. Nueva aceptación: miniweb común Folio sobria y completa, contenido real del profesional/clínica, edición de datos, vista completa y alta opcional. Preservar permisos, consentimiento, reservas y persistencia; no presentar una vista reducida como producto final |
