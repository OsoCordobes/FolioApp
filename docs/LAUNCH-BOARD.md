...
| Aviso Google en Hoy móvil | mobile_google_notice · rama codex/launch-mobile-calendar-notice. Sólo components/hoy/gcal-nudge-banner.tsx y CSS asociado. | Defecto visual observado en caller-hoy-375.png del ensayo36124468806:220px de alto y texto estrecho. Componente real375/1440, capturas antes/después, foco/teclado y ausencia de desborde; typecheck y lint proporcionales. No cambia conexión ni activa Google. |
...
| Atención adulta · B04 | Base privada PR183 publicada y comprobada; interfaz, criterio clínico y activación pendientes | Proteger nuevas atenciones; conservar historias, consultas iniciadas y correcciones autorizadas. Activación separada de instalación. |
